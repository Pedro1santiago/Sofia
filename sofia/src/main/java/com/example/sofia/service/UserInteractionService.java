...
public class UserInteractionService {
    ...
    public UserInteraction saveInteraction(UserInteractionDTO dto) {
        ...
        userInteraction.setLocalizacao(dto.localizacao());
        userInteraction.setEstado(dto.estado());
        userInteraction.setCidade(dto.cidade());
        userInteraction.setBairro(dto.bairro());
